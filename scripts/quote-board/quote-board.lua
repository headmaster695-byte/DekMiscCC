...
local SONGS = {
  ...
  {
    -- 'A New Start' by Nanashi Mumei — 16-speaker lofi remix.
    -- MusicXML: arrangement by Molybdaen42. Transposed D→G (−7 st), lofi ×1.18.
    -- Voices: 1 lead harp  2 lead flute  3 harm 3rd-below  4 harm 3rd-above
    --         5 inner-v2   6 inner-v3    7 mel sustained    8 mel octave-low
    --         9 bass-hi   10 bass-lo     11 bass slow       12 bass structural
    --        13 shimmer   14 chord sustain  15 beat pulse   16 G drone
